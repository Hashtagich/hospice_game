    ...
    return (
        <section id='mobilegame' className={styles.container}>
            ...
            <div className={styles.wrapperDescriptionMobileVersion}>
                ...
                <a className={styles.bottomLine} href='https://www.figma.com/design/wn8i34WXIVj03MoE4tyyBZ/%D0%97%D0%B0%D0%BC%D0%BE%D0%BA-%D0%B7%D0%B0%D0%B1%D0%BE%D1%82%D1%8B?node-id=0-1&node-type=canvas&t=YCW9gKxGRckBfqb3-0' rel="noopener noreferrer" target='_blank'><Button className={styles.button} nameButton='Перейти'/></a>
