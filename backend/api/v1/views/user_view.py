...
#     serializer_class = AttributeUpSerializer
#
#     def get_object(self):
...
#
#                 try:
#                     user_attributes.level_up(point=point)
#                     user_attributes.save()
#                     return Response({f"message": f"Уровень успешно увеличен на {point}"}, status=status.HTTP_200_OK)
#
...
#
#                 try:
#                     user_attributes.money_up(point=point)
#                     user_attributes.save()
#                     return Response({f"message": f"Кол-во монет успешно увеличено на {point}"},
